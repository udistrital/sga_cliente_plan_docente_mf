export const environment = {
    ...
    SGA_PLAN_TRABAJO_DOCENTE_MID_SERVICE: 'http://localhost:8552/v1/',//'https://autenticacion.portaloas.udistrital.edu.co/apioas/sga_mid/v1/',
    ...
    SGA_ESPACIOS_ACADEMICOS_MID_SERVICE: 'https://localhost:8080/v1/',
